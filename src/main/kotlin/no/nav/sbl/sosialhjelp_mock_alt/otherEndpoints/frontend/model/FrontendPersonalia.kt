...
data class FrontendBarn(
    ...
    var folkeregisterpersonstatus: PdlFolkeregisterpersonstatus = PdlFolkeregisterpersonstatus.bosatt,
    ...
    companion object {
        fun frontendBarn(fnr: String, pdlBarn: PdlSoknadBarn): FrontendBarn {
            ...
            return FrontendBarn(
                ...
                foedsel = pdlBarn.foedsel?.first()?.foedselsdato
    ...
    companion object {
        fun oversettTilInntektsmottaker(frontEnd: FrontendSkattbarInntekt): OppgaveInntektsmottaker {
            return OppgaveInntektsmottaker.Builder()
                ...
                .leggTilForskuddstrekk(
                    Forskuddstrekk.Builder().beloep(-frontEnd.trekk.toInt())
                        .build()
                )
                .leggTilInntekt(
                    Inntekt.Builder()
            ...
            return utbetalingerFraNav.flatMap { utbetalingFraNav ->
                utbetalingFraNav.ytelseListe?.map {
                    FrontendUtbetalingFraNav(
                        ...
                        dato = utbetalingFraNav.utbetalingsdato
                            ?: LocalDate.now(),
...
class FrontendArbeidsforhold(
    ...
    companion object {
        fun arbeidsforhold(
            ...
            val orgnavn =
                eregService.getOrganisasjonNoekkelinfo(orgnummer)?.navn?.navnelinje1
                    ?: ""
