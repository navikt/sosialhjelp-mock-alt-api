...
import no.nav.sbl.sosialhjelp.mock.alt.datastore.bostotte.model.BostotteDto
...
import no.nav.sbl.sosialhjelp.mock.alt.otherEndpoints.frontend.model.FrontendPersonalia.Companion.pdlPersonalia
import no.nav.sbl.sosialhjelp.mock.alt.otherEndpoints.frontend.model.FrontendSkattbarInntekt
import no.nav.sbl.sosialhjelp.mock.alt.otherEndpoints.frontend.model.FrontendSoknad
import no.nav.sbl.sosialhjelp.mock.alt.otherEndpoints.frontend.model.FrontendVedlegg
import no.nav.sbl.sosialhjelp.mock.alt.otherEndpoints.frontend.model.toFrontend
...
class FrontendController(
    ...
    ): ResponseEntity<FrontendPersonalia> {
        val personalia =
            try {
    ...
    fun soknadsListe(): ResponseEntity<Collection<FrontendSoknad>> =
        ResponseEntity.ok(
            soknadService.listSoknader(null).map {
                toFrontendSoknad(it)
            },
        )
