package no.nav.sbl.sosialhjelp.mock.alt.datastore.fiks.dokumentlager

import no.nav.sbl.sosialhjelp.mock.alt.datastore.fiks.SoknadService.Companion.log
...
class FixedFileStorage {
    ...
    fun find(key: String): FileEntry? = items.findLast { it.key == key }
}
