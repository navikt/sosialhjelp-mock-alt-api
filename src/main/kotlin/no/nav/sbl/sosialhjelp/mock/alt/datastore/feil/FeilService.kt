package no.nav.sbl.sosialhjelp.mock.alt.datastore.feil

import kotlinx.coroutines.delay
import kotlinx.coroutines.runBlocking
import no.nav.sbl.sosialhjelp.mock.alt.KonfigurertFeil
...
class FeilService {
    ...
    fun setFeilForFnr(
        fnr: String,
        nyeFeilsituasjoner: List<Feilsituasjon>,
    ) {
        feilsituasjoner[fnr] = nyeFeilsituasjoner
    }

    fun eventueltLagFeil(
        headers: HttpHeaders,
        className: String,
        functionName: String,
    ) {
    ...
    fun hentFeil(fnr: String): List<Feilsituasjon> = feilsituasjoner[fnr] ?: emptyList()

    fun hentAlleFeilene(): HashMap<String, List<Feilsituasjon>> = feilsituasjoner
