package no.nav.sbl.sosialhjelp.mock.alt.datastore.ereg

import no.nav.sbl.sosialhjelp.mock.alt.datastore.ereg.model.NavnDto
import no.nav.sbl.sosialhjelp.mock.alt.datastore.ereg.model.OrganisasjonNoekkelinfoDto
...
class EregService {
    ...
    fun putOrganisasjonNoekkelinfo(
        orgnummer: String,
        orgnavn: String,
    ) {
