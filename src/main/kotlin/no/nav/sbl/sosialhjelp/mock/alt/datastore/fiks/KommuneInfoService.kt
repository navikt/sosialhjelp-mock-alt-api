...
class KommuneInfoService {
    ...
    fun hentAlleKommuner(): Collection<KommuneInfo> = kommuneInfoMap.values

    fun getKommuneInfo(kommunenummer: String): KommuneInfo = kommuneInfoMap[kommunenummer] ?: lagKommuneInfo(kommunenummer)
