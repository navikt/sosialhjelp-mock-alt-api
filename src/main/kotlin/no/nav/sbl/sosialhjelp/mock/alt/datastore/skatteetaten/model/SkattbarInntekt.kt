package no.nav.sbl.sosialhjelp.mock.alt.datastore.skatteetaten.model
...
class OppgaveInntektsmottaker(
    ...
    data class Builder(
        ...
        fun opplysningspliktigId(opplysningspliktigId: String) =
            apply {
...
class Inntekt(
    ...
    data class Builder(
        ...
        var aldersUfoereEtterlatteAvtalefestetOgKrigspensjon: AldersUfoereEtterlatteAvtalefestetOgKrigspensjon? =
            null,
    ) {
        fun skatteOgAvgiftsregel(skatteOgAvgiftsregel: String) =
            apply {
        ...
        fun utloeserArbeidsgiveravgift(utloeserArbeidsgiveravgift: Boolean) =
            apply {
                this.utloeserArbeidsgiveravgift = utloeserArbeidsgiveravgift
            }

        fun inngaarIGrunnlagForTrekk(inngaarIGrunnlagForTrekk: Boolean) =
            apply {
...
class Tilleggsinformasjon(
    ...
    data class Builder(
        ...
        fun ofType(type: Inntektstype? = null) =
            apply {
                if (type != null) {
                    when (type) {
                        Inntektstype.DagmammaIEgenBolig -> dagmammaIEgenBolig = DagmammaIEgenBolig()
