...
import no.nav.sbl.sosialhjelp.mock.alt.datastore.bostotte.BostotteService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.ereg.EregService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.fiks.MockedSoknadState
import no.nav.sbl.sosialhjelp.mock.alt.datastore.fiks.SoknadService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.kontonummer.KontoregisterService
...
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.Kjoenn
...
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlFoedselsdato
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlFolkeregisterpersonstatus
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlForelderBarnRelasjon
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlInnsynHentPerson
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlInnsynPerson
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlInnsynPersonResponse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlKjoenn
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlModiaHentPerson
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlModiaPerson
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlModiaPersonResponse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlPersonNavn
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSivilstand
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadAdressebeskyttelse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadAdressebeskyttelseResponse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadBarn
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadBarnResponse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadEktefelle
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadEktefelleResponse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadHentAdressebeskyttelse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadHentBarn
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadHentEktefelle
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadHentPerson
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadPerson
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadPersonNavn
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlSoknadPersonResponse
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlStatsborgerskap
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.PdlTelefonnummer
...
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.model.SivilstandType
import no.nav.sbl.sosialhjelp.mock.alt.datastore.roller.RolleService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.roller.model.AdminRolle
import no.nav.sbl.sosialhjelp.mock.alt.datastore.skatteetaten.SkatteetatenService
...
import no.nav.sbl.sosialhjelp.mock.alt.datastore.skatteetaten.model.SkattbarInntekt
...
import no.nav.sbl.sosialhjelp.mock.alt.utils.genererTilfeldigKontonummer
import no.nav.sbl.sosialhjelp.mock.alt.utils.genererTilfeldigOrganisasjonsnummer
import no.nav.sbl.sosialhjelp.mock.alt.utils.genererTilfeldigPersonnummer
import no.nav.sbl.sosialhjelp.mock.alt.utils.genererTilfeldigTelefonnummer
...
class PdlService(
    ...
    fun getModiaResponseFor(ident: String): PdlModiaPersonResponse {
        ...
        val foedselsdato = PdlFoedselsdato("1945-10-26", 1945)
    ...
    fun getSoknadPersonResponseFor(ident: String): PdlSoknadPersonResponse {
        ...
        var foedselsdato = PdlFoedselsdato("2020-01-01", 2020)
        ...
        if (personalia != null) {
            ...
            foedselsdato = personalia.foedselsdato
            if (
    ...
    fun getPersonalia(ident: String): Personalia = personListe[ident] ?: throw MockAltException("Ident $ident not found!")

    fun getBarn(ident: String): PdlSoknadBarn = barnMap[ident] ?: throw MockAltException("Barn with ident $ident not found!")
