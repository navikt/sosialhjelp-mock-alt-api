package no.nav.sbl.sosialhjelp.mock.alt.integrations.pdl

import graphql.parser.Parser
import no.nav.sbl.sosialhjelp.mock.alt.datastore.feil.FeilService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.PdlAdresseSokService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.PdlGeografiskTilknytningService
import no.nav.sbl.sosialhjelp.mock.alt.datastore.pdl.PdlService
import no.nav.sbl.sosialhjelp.mock.alt.integrations.pdl.model.HentGeografiskTilknytningRequest
import no.nav.sbl.sosialhjelp.mock.alt.integrations.pdl.model.HentPersonRequest
import no.nav.sbl.sosialhjelp.mock.alt.integrations.pdl.model.MockGraphQLRequest
import no.nav.sbl.sosialhjelp.mock.alt.integrations.pdl.model.SokAdresseRequest
...
class PdlController(
    ...
    private fun handleHentPersonRequest(
        body: String,
        ident: String,
    ): String {
    ...
    private fun handleSokAdresseRequest(
        body: String,
        ident: String,
    ): String {
